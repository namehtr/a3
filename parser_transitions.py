...
def minibatch_parse(sentences, model, batch_size):
    ...
    for partial_parses in np.array_split([PartialParse(sentence) for sentence in sentences],batch_size):
        unfinished_parses = partial_parses[:]
        while(len(unfinished_parses)!=0):
            transitions = model.predict(unfinished_parses)
            for i,unfinished_parse in enumerate(unfinished_parses):
        ...
        dependencies = dependencies + [partial_parse.dependencies for partial_parse in partial_parses]
